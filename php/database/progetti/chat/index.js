$(document).ready(function(){
    ...
    function chatBox(id_user_r, id_username_r){
        ...
        modal_content += '<div style="height:400px; border:1px solid #ccc; overflow-y: scroll; margin-bottom:24px; padding:16px;" class="chat_history" data-toiduser="'+id_user_r+'" id="chat_history_'+id_user_r+'">';
        modal_content += '</div>';
